...
// locally (make build-ffi, from ffi/libiroh) and linked from here.
...
// #cgo darwin LDFLAGS: -L${SRCDIR}/libiroh/target/release -liroh -lc++ -framework CoreFoundation -framework Security -framework SystemConfiguration -framework CoreWLAN
import "C"
